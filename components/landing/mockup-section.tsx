      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-20">
        <div className="md:w-1/2 text-left space-y-8 order-2 md:order-1">
          <div className="space-y-4">
            ...
            <p className="text-lg text-primary/60 max-w-sm leading-relaxed">
...
function PhoneMockup() {
  return (
    <div className="relative w-[300px] h-[600px] phone-mockup rounded-[3rem] bg-[oklch(0.06_0.01_290)] p-3 border-[6px] border-[oklch(0.15_0.01_290)]">
      <div className="screen-content-gradient w-full h-full rounded-[2.2rem] overflow-hidden p-8 flex flex-col justify-center space-y-12 relative">
        {/* Dynamic Island */}
        <div className="absolute top-4 left-1/2 -translate-x-1/2 w-24 h-6 bg-[oklch(0.06_0.01_290)] rounded-full" />

        <div className="space-y-10">
          <div className="space-y-3">
            <p className="text-[10px] tracking-[0.05rem] text-primary/30 uppercase">
              User
            </p>
            <p className="text-base text-primary/90 italic leading-relaxed">
              &ldquo;I don&apos;t even know why I feel this way.&rdquo;
            </p>
          </div>
          <div className="space-y-4 border-l-2 border-secondary/20 pl-6">
            <p className="text-[10px] tracking-[0.05rem] text-secondary/60 uppercase">
              The Mirror
            </p>
        ...
        {/* Decorative glow */}
        <div className="absolute bottom-[-50px] left-[-20px] w-48 h-48 bg-secondary/5 blur-[40px] rounded-full pointer-events-none" />
      </div>
    </div>
  )
}
