...
/* ------------------------------------------------------------------ */
/*  Stacked / fanned-deck carousel — one card focused, neighbors        */
/*  peeking left and right. Distinct from FounderCarousel's horizontal  */
/*  scroll track, used specifically for the advisors section.           */
/* ------------------------------------------------------------------ */
  ...
  return (
    ...
    >
      ...
      <blockquote className="min-h-0 flex-1">
        <p className="line-clamp-5 font-serif text-xl leading-relaxed text-foreground/85 italic md:text-2xl">
          {advisor.bio}
        </p>
      </blockquote>
...
export function AdvisorCarousel({ advisors }: { advisors: Founder[] }) {
