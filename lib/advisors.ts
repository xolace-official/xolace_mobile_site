...
// photos before this section goes live. `image` currently points at
// i.pravatar.cc placeholder headshots for layout testing only — replace
// with real photos before launch. Bios are capped around 29 words —
